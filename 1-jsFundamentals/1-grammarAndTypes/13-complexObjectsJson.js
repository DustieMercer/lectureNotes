...
console.log(Object.keys(spaceJam.toonSquad.toString)); //"tostring" changes to a string
console.log(Object.keys(spaceJam.toonSquad)); //without "tostring" shows as an array
...
let inc = 'vegtable';
console.log(garden[inc]); //zucchini
